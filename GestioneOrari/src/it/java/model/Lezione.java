...
import it.java.domain.TipologiaLezione;
import it.java.validator.DisponibilitaDocentePerLezione;
...
@Views({ @View(members = "" + "Generalità[tipologialezione  ; " + "iniziolezione, " + "finelezione  ; "
		+ "identificativoattivita, " + "identificativoaula;" + "identificativodocente ;] "),
		@View(name = "referenceAula", members = "" + "Generalità[tipologialezione  ; " + "iniziolezione, "
				+ "finelezione  ; " + "identificativoattivita; " + "identificativodocente;] "),
		@View(name = "referenceAttivita", members = "identificativolezione,identificativoattivita.identificativoattivita;"
				+ "Generalità[tipologialezione  ; " + "iniziolezione, " + "finelezione  ; " + "identificativoaula;"
				+ "identificativodocente ;]  "),
		@View(name = "referenceDocente", members = "" + "Generalità[tipologialezione  ; " + "iniziolezione, "
				+ "finelezione  ; " + "identificativoattivita, " + "identificativoaula;] "), })
@Tab(properties = " tipologialezione " + ",  iniziolezione " + ",  finelezione "
		+ ", identificativoattivita.nomeattivita " + ", identificativoaula.nomeaula"
		+ ", identificativodocente.denominazione")



@EntityValidator( 
		value = DisponibilitaDocentePerLezione.class,  message="{ErroreLezione}",
		properties = { 
...
public class Lezione {
	...
	@ReadOnly
	@Id
	@Column(name = "identificativoLezione")
	...
	public TipologiaLezione getTipologialezione() {
		return tipologialezione;
	}

	public void setTipologialezione(TipologiaLezione tipologialezione) {
